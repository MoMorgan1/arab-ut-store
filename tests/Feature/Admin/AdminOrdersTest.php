...
test('admin navigation URLs stay inside the matched route family', function (string $path, array $expectedUrls): void {
    ...
    'Canonical family' => ['/admin/orders', ['/admin', '/admin/orders', '/admin/customers', '/admin/marketing/coupons', '/admin/products', '/admin/marketing/loyalty', '/admin/settings']],
    'Localized family' => ['/en/admin/orders', ['/en/admin', '/en/admin/orders', '/en/admin/customers', '/en/admin/marketing/coupons', '/en/admin/products', '/en/admin/marketing/loyalty', '/en/admin/settings']],
]);
