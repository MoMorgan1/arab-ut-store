...
return [
    'accountCheck' => [
        ...
        'wrongPersona' => ['status' => OrderStatus::WaitingForCustomer, 'hold' => OrderHoldReason::Platform, 'actions' => [SupplierAction::EditCredentials, SupplierAction::Resume]],
        ...
        '2FADisabled' => ['status' => OrderStatus::WaitingForCustomer, 'hold' => OrderHoldReason::TwoFactorOff, 'actions' => [SupplierAction::Resume]],
        'no2fa' => ['status' => OrderStatus::WaitingForCustomer, 'hold' => OrderHoldReason::TwoFactorOff, 'actions' => [SupplierAction::Resume]],
        'No2FA' => ['status' => OrderStatus::WaitingForCustomer, 'hold' => OrderHoldReason::TwoFactorOff, 'actions' => [SupplierAction::Resume]],
    ...
    'economyState' => [
        ...
        'insufficientFunds' => ['status' => OrderStatus::InProgress, 'hold' => OrderHoldReason::StoreStock, 'actions' => [SupplierAction::Resume]],
        'FailWebAppNotYetUnlocked' => ['status' => OrderStatus::WaitingForCustomer, 'hold' => OrderHoldReason::WebAppLocked, 'actions' => [SupplierAction::EditCredentials, SupplierAction::Resume]],
        'tempbanCooldown' => ['status' => OrderStatus::InProgress, 'hold' => OrderHoldReason::Paused, 'actions' => [SupplierAction::Resume]],
        'listingTempban' => ['status' => OrderStatus::InProgress, 'hold' => OrderHoldReason::Paused, 'actions' => [SupplierAction::Resume]],
