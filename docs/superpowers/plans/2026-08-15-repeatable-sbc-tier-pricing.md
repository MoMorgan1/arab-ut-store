...
- [ ] **Step 1: Add failing workflow tests for the approved tier matrix**
...
- [ ] **Step 2: Run the workflow tests and capture RED**
...
- [ ] **Step 3: Implement deterministic tier generation**
...
- [ ] **Step 4: Make workflow validation exact and fail closed**
...
- [ ] **Step 5: Regenerate the export and run GREEN**
...
- [ ] **Step 1: Write RED unit tests for parsing and legacy fallback**
...
- [ ] **Step 2: Write RED feature tests for snapshot atomicity and versioning**
...
- [ ] **Step 3: Run focused PHP tests and capture RED**
...
- [ ] **Step 4: Implement the immutable parser/resolver**
...
- [ ] **Step 5: Enforce the parser only on the SBC snapshot request**
...
- [ ] **Step 6: Extend price-version authority**
...
- [ ] **Step 8: Commit the Laravel pricing boundary**
...
- [ ] **Step 1: Write RED cart request and idempotency tests**
...
- [ ] **Step 2: Write RED checkout tests**
...
- [ ] **Step 4: Add count validation and fingerprinting**
...
- [ ] **Step 5: Resolve the selected tier under the variant lock**
...
- [ ] **Step 6: Revalidate tiers at checkout and expose safe cart configuration**
...
- [ ] **Step 8: Commit cart and checkout integrity**
...
- [ ] **Step 1: Write RED backend presentation tests**
...
- [ ] **Step 2: Write RED React and API tests**
...
- [ ] **Step 4: Expose sanitized converted tiers**
...
- [ ] **Step 5: Implement the WP-aligned selector and synchronous summary**
...
- [ ] **Step 6: Show completion count in cart lines**
...
- [ ] **Step 8: Commit the storefront selector**
...
- [ ] **Step 3: Implement the optional selection line and responsive sizing**
...
- [ ] **Step 4: Run GREEN and accessibility-oriented static checks**

Run focused Vitest, ESLint, Prettier, TypeScript, and production build.

- [ ] **Step 5: Commit notice polish**
...
- [ ] **Step 1: Run aggregate repository gates**
...
- [ ] **Step 2: Run the exact workflow package gate**

Run: `npm --prefix automation/n8n/sbc-catalog-v1 test`
Expected: export freshness and all workflow tests pass.

- [ ] **Step 3: Run MariaDB critical selections**
...
- [ ] **Step 4: Run AR/EN browser matrix**
...
- [ ] **Step 6: Write the final report and commit evidence**
