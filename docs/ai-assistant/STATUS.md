...
| Complete `php C:\temp\arabut-composer\composer.phar ci:check` | Passed locally: exit 0; Pint and PHPStan passed, Pest passed 856 tests / 33,171 assertions, Vitest passed 52 files / 369 tests, and the remaining frontend/build gates completed. |
| Complete `npm run test:e2e`                                   | Passed locally: exit 0; 7 Chromium tests passed in 44.2 seconds, including the authenticated account test in 28.9 seconds.                                                        |
