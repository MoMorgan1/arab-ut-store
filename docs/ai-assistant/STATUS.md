...
| Conversation title                    | Implemented 2026-09-15 (owner decision the same day): one extra short model call after the first reply names the thread; shown in the chat header and the history list. See AGENT-RUNTIME.md.                            |
