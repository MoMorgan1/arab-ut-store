...
release, operational flags, open findings, owner acceptance, and exact next
task. Then use the relevant canonical document below.
...
| Operations and release    | [OPERATIONS.md](OPERATIONS.md)       | Implemented                                              |
...
| AI turn runtime           | [AGENT-RUNTIME.md](AGENT-RUNTIME.md) | Planned                                                  |
...
| Evaluation                | [EVALS.md](EVALS.md)                 | Planned                                                  |
