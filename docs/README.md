...
| [Coins pricing baseline read](api/n8n-pricing-baseline-read-v1.md)        | Signed read of what the store last published, for a run whose workflow memory is empty                   | Implemented                                         |
...
| [Customer notification API](api/n8n-customer-notification-v1.md)         | Signed store-to-n8n WhatsApp request for order holds, cancellation, and refund                           | Implemented; webhook unconfigured so sending is inert |
