...
export const englishAdminUi: AdminTranslations = {
    ...
    orders: {
        manual: {
            ...
            title: 'New order',
            description:
                "A real order on the customer's account: an order number, a tracking page, and a link you can send.",
            close: 'Close',
            typeLabel: 'Type',
            typeTransfer: 'Bank transfer',
            typeGift: 'Gift',
            transferNote:
                'Earns cashback and loyalty, the same as a card payment.',
            giftNote: 'No cashback and no loyalty on a gift.',
            customerLabel: 'Customer',
            customerPlaceholder: 'Phone, email, name or customer number',
            customerHelp:
                'A customer who does not exist yet is created on the customers page first.',
            customerSearching: 'Searching\u00e2\u20ac\u00a6',
            ...
            deliveryPlacedBody:
                "Paste each item's supplier reference below. The job is bound to it at creation and tracked from the next read.",
            deliveryLaterTitle: 'Not placed yet',
            deliveryLaterBody:
                'The order is created and waits. The store does not dispatch to a supplier yet, so someone places it and adds the reference afterwards.',
            ...
            priceUse: 'Use it',
            priceChanged:
                'Changed from :price. The order records what you set.',
            ...
            credentialsOptional:
                'The password and backup codes are optional \u00e2\u20ac\u201d you signed in yourself. Add them only if a later phase will run from the store.',
            ...
            challengeIdsHelp:
                'One per line. A challenge placed by hand cannot be tracked without them.',
            uttNoChallenges:
                'UTT delivers coins only, so a challenge leaves FFT as the only choice.',
            placementUnavailable:
                'This service is delivered by a person, so it carries no supplier reference.',
            paymentLabel: 'Payment received',
            paymentAmount: 'Amount',
            paymentAmountHelp:
                'The transfer records the order total, so this follows the items above.',
            paymentReceivedAt: 'Received on',
            paymentReference: 'Transfer reference',
            paymentHelp:
                'Recorded as a payment on the order, so it lands in the same reports as a card payment.',
            giftHeading: 'No payment on a gift',
            giftBody:
                'Zero total, no payment record, no cashback. That is also what marks it a gift: a bank transfer always carries money, so the two cannot be confused.',
            total: 'Order total',
            auditNote:
                'Records who created it and when. The EA password is never in that record.',
            submit: 'Create order',
            ...
            errors: {
                ...
                optionsFailed:
                    'The choices could not be loaded. Close the drawer and open it again.',
    ...
    reviews: {
        ...
        createdAt: 'Received',
        description:
            'Read the reviews customers left on their orders and choose which ones the store shows.',
        ...
        headTitle: 'Reviews',
        hideDialogDescription:
            'The review disappears from the store immediately. You can show it again at any time.',
        hideDialogTitle: 'Hide this review from the store?',
        hideFromStore: 'Hide from store',
        hidingFromStore: 'Hiding from store…',
        lastPage: 'Last page',
        loadFailed:
            'We could not refresh the review list. Please check your connection and try again.',
        ...
        showDialogDescription:
            "The review appears in the store under the reviewer's name with the verified order badge.",
        ...
        visibilityUpdateFailed:
            'We could not update the review visibility. Please check your connection and try again.',
    },
    faq: {
        actions: 'Actions',
