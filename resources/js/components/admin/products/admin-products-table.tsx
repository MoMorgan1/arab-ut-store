...
import AdminProductsMobileCard from '@/components/admin/products/admin-products-mobile-card';
...
export type AdminProductsTableProps = {
    ...
    locale: 'ar' | 'en';
    onResetFilters: () => void;
    table: TanStackTable<AdminProductRow>;
};
...
function ariaSort(
    ...
    const columnToSortKey: Record<string, ProductSortKey> = {
