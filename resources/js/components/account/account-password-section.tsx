...
export default function AccountPasswordSection({
    ...
    const isChange = passwordMode === 'change';
    ...
    function submit(event: FormEvent) {
        ...
        if (isChange) {
            form.put(actions.changePasswordUrl, options);
        } else {
            form.post(actions.setupPasswordUrl, options);
        }
    }
        ...
        <section className="account-profile-section account-security-section">
            ...
            <form onSubmit={submit}>
                ...
                {form.recentlySuccessful ? (
                    <p className="account-security-success" role="status">
