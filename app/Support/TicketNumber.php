...
/**
 * Short, human-friendly, non-sequential support ticket numbers such as TKT-7K4QXM.
 *
...
final class TicketNumber
{
    ...
    public const PATTERN = '/^TKT-[23456789ABCDEFGHJKLMNPQRSTUVWXYZ]{6}$/';
    ...
    public static function generate(): string
    {
        for ($attempt = 0; $attempt < self::MAX_ATTEMPTS; $attempt++) {
            ...
            if (SupportTicket::query()->where('ticket_number', $candidate)->doesntExist()) {
                return $candidate;
            }
        }
