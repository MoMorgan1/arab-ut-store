...
use App\Actions\Cart\AddFutChampionsToCart;
use App\Actions\Cart\ResolveCartOwner;
use App\Exceptions\Cart\DuplicateCartItem;
use App\Exceptions\Cart\ReplacedCartItemMissing;
use App\Exceptions\IdempotencyConflict;
use App\Http\Controllers\Controller;
use App\Http\Requests\Store\FutChampionsCartRequest;
use DomainException;
use Illuminate\Http\JsonResponse;

final class FutChampionsCartController extends Controller
{
    public function __invoke(
        FutChampionsCartRequest $request,
        AddFutChampionsToCart $addToCart,
