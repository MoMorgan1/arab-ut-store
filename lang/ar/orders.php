...
return [
    ...
    'hold_reasons' => [
        ...
        'platform' => 'منصة الحساب تختلف عن المنصة المختارة في الطلب. عدّل الإيميل بحساب على نفس المنصة من زر تعديل البيانات، وإذا كانت المنصة في الطلب هي الخطأ راسلنا — لكل منصة سعر مختلف.',
        ...
        'ea_servers' => 'خوادم EA رفضت تسجيل الدخول في الوقت الحالي. نعيد المحاولة تلقائياً، ولو تبي تجرب الآن اضغط «تشغيل الطلب».',
        ...
        'store_stock' => 'الكمية المطلوبة غير متوفرة لدينا في الوقت الحالي. نجهّزها ونستأنف طلبك تلقائياً، ولو تبي تجرب الآن اضغط «تشغيل الطلب».',
        'connection' => 'انقطع الاتصال بخوادم اللعبة أثناء التنفيذ. نعيد المحاولة تلقائياً، ولو تبي تجرب الآن اضغط «تشغيل الطلب».',
        'no_player' => 'لم نجد لاعباً مناسباً في السوق لإتمام الشحن الآن. نتابع السوق ونستأنف تلقائياً، ولو تبي تجرب الآن اضغط «تشغيل الطلب».',
        'maintenance' => 'خوادم اللعبة في صيانة من EA. نستأنف التنفيذ تلقائياً فور انتهائها، ولو تبي تجرب الآن اضغط «تشغيل الطلب».',
        'paused' => 'طلبك متوقف مؤقتاً وسنعاود التنفيذ تلقائياً. لو تبي تجرب الآن اضغط «تشغيل الطلب»، أو راسلنا لمعرفة التفاصيل.',
        'two_factor_off' => 'التحقق الثنائي غير مفعّل على الحساب. فعّله من إعدادات أمان حساب EA ثم اضغط «تشغيل الطلب».',
        'email_confirm' => 'حساب EA يطلب تأكيد البريد الإلكتروني. أكّده من رسالة EA ثم اضغط «تشغيل الطلب»، ولو الإيميل نفسه غلط عدّله من «تعديل البيانات».',
        'web_app_locked' => 'تطبيق الويب غير مفعّل على الحساب. ادخله مرة واحدة من المتصفح ثم اضغط «تشغيل الطلب».',
        'below_minimum' => 'المبلغ المتبقي أقل من الحد الأدنى للنقل. جاري إنهاء الطلب، ولو تبي تجرب الآن اضغط «تشغيل الطلب».',
    ],
    'tracking_states' => [
        'processing' => [
        ...
        'cooldown_tempban' => [
            'headline' => 'جاري المعالجة',
            'subline' => 'نعمل على الطلب حالياً. تقدر تدخل وتلعب بشكل طبيعي، وأول ما تطلع من اللعبة يكمل الشحن تلقائياً.',
        ],
        'cooldown_listing' => [
            'headline' => 'جاري المعالجة',
...
ومبروك عليك التشكيلة!',
    ...
    'challenge_status_help' => [
        ...
        'two_factor_off' => [
            ...
            'desc' => 'التحقق الثنائي (2FA) غير مفعّل على الحساب، ونحتاجه حتى نكمل.',
