...
return [
    ...
    'hold_reasons' => [
        ...
        'two_factor_off' => 'التحقق الثنائي غير مفعّل على الحساب. فعّله من إعدادات أمان حساب EA ثم حدّث الطلب.',
        'email_confirm' => 'حساب EA يطلب تأكيد البريد الإلكتروني. أكّده من رسالة EA ثم حدّث الطلب.',
        'web_app_locked' => 'تطبيق الويب غير مفعّل على الحساب. ادخله مرة واحدة من المتصفح ثم حدّث الطلب.',
