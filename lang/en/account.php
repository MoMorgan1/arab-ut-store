...
return [
    ...
    'orders' => [
        ...
        'tracking' => [
            'freshness_just_now' => 'Updated just now',
            'freshness_minutes' => 'Updated :count minutes ago',
            'freshness_hours' => 'Updated :count hours ago',
            'freshness_days' => 'Updated :count days ago',
            'eta' => 'About :duration remaining',
            'eta_hours_minutes' => ':hours h :minutes min',
            'eta_minutes' => ':count min',
            'delivered' => 'Delivered',
            'remaining' => 'Remaining',
            'account_coins' => 'Coins in the account',
            'account_coins_preparing' => 'Being prepared',
            'coins_unit' => 'coins',
            'action_required' => 'Action needed:',
            'info' => 'Heads up:',
            'edit_credentials' => 'Update order details',
            'resume' => 'Start the order',
            'retry_challenge' => 'Try again',
            'retrying' => 'Starting the order',
            ...
            'edit_codes' => 'Backup codes',
            'edit_codes_note' => 'Three different codes, six or eight digits each.',
            'edit_submit' => 'Save details',
            'edit_cancel' => 'Cancel',
            'edit_fix' => 'Check the marked fields below.',
            'edit_bad_email' => 'That email address is not right.',
            'edit_need_password' => 'Enter the password.',
            'edit_bad_code' => 'Six or eight digits.',
            'edit_same_codes' => 'The three codes must be different.',
            'credentials_pending' => 'We have your new details and are trying them. The status updates here.',
            'progress' => 'Progress',
            'squads' => ':done / :total squads (:percent%)',
            'repeat' => 'Challenge repeats',
            'coins_used' => 'Coins used',
            'show_status' => 'Show status',
            'hide_status' => 'Hide status',
            'challenge_help_default' => 'We are working on this challenge; nothing is needed from you.',
            'close' => 'Close',
            'help_action_label' => 'What to do:',
            'challenge_help' => 'About this challenge',
            'challenges_all_done' => 'All squad building challenges are complete',
            'challenges_count' => ':count squad building challenge orders',
            'order_completed_ago' => 'Order completed :when',
            'challenge_completed_ago' => 'Completed :when',
            'tab_coins' => 'Coins delivery',
            'tab_challenges' => 'SBC challenges',
            'console_playstation' => 'PlayStation',
            'console_xbox' => 'Xbox',
            'console_pc' => 'PC',
        ],
        'details' => 'Details',
