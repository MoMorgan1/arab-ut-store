...
return [
    ...
    'login' => [
        ...
        'phone_help' => "Didn't receive the code? Make sure WhatsApp is active on this number, or",
        'phone_help_support' => 'contact support',
        'email_code_title' => 'Your account has no password',
        'email_code_intro' => 'Your account came from our previous store and has no password. We sent a 6-digit code to :email.',
