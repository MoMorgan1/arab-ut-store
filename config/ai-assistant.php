...
return [
    ...
    'max_output_tokens' => env('AI_MAX_OUTPUT_TOKENS', 500),
    ...
    'request_timeout_seconds' => env('AI_REQUEST_TIMEOUT_SECONDS', 45),
    ...
    'stale_turn_seconds' => env('AI_STALE_TURN_SECONDS', 120),
